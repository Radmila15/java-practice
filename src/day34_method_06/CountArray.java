...
public class CountArray {
	public static void main(String[] args) {
		...
		//create array and pass to methods
	 ...
	 * Method will look for value in the array and return the count of
	 * occurences
	 */
...
//build array and assign value then return it
	public static int[] getArray() {
		int[] retArray = {2,23,86,53,96};
		return retArray;
	}
	
		public static int[] getRandomArray(int size) {
			Random rand = new Random(); // createRandom class object
