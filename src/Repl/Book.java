...
public class Book {
	...
	public static String capitalize(String word) {
		...
		return word.substring(0, 1).toUpperCase() + word.substring(1, word.length() - 1).toLowerCase();
	}
	...
	public static Boolean isTitleWord(String word) {
		String[] david = { "a", "an", "the", "and", "but", "for", "nor", "or", "so", "yet", "at", "by", "in", "into",
				"near", "of", "on", "to", "than", "via" };
		for (String eachDavid : david) {
			if (eachDavid.equals(word.toLowerCase())) {
				return false;
			}
		}
